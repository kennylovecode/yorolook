                ...
                <el-col :xs="24" :sm="12" :md="12" :lg="4" :xl="4">
                  <el-form-item prop="type" label-width="100%">
                    <el-select
                      ...
                      :key="masterType.key + formModel.type"
                      multiple
                      filterable
                      :placeholder="masterType.text"
                      :multiple-limit="3"
                    >
                      <el-option
                        v-for="item in masterType?.options"
                        :key="item.key"
                        :label="item.text"
                        :value="item.text"
                      />
...
import { IMaster, Contact } from "@/api/master/types"
...
const formModel = reactive<IMaster>({
  id: "",
  title: "",
  sub_title: "",
  type: "",
...
const rules = reactive<FormRules<IMaster>>({
  title: [
...
const handleInitialize = async (model: IMaster) => {
