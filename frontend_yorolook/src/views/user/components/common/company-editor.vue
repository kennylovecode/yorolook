  ...
  <div class="profile">
    <el-form ref="formRef" :model="supplierProfile" :rules="rules" label-width="80px" label-position="top">
      ...
      <el-form-item label="标题" prop="title">
        <el-input v-model="supplierProfile.title" placeholder="请输入显示的商家标题" size="default" clearable />
      </el-form-item>
      <!--el-form-item label="所在国家" prop="country">
        <el-select v-model="supplierProfile.country" placeholder="请选择国家" size="default" clearable>
