...
import MainTopmenu from "../navigation/MainTopmenu.vue";
...
<template>
  ...
  <v-app-bar :density="mdAndUp ? 'default' : 'compact'">
    ...
    <div v-else class="px-2 d-flex align-center justify-space-between w-100">
      ...
      <v-spacer></v-spacer>
      <!--div>
        <v-text-field v-if="mdAndUp" class="ml-2" :style="{ width: `${searchWidth}px` }" color="primary" variant="solo" density="compact"
