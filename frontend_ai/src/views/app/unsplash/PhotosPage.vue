...
const search = async () => {
  ...
  // Photos
  photoData.photos = response.data.results;
  photoData.total = response.data.total;
  photoData.totalPages = response.data.total_pages;
  ...
  // // Collections
  collectionData.collections = collectionResponse.data.results;
  collectionData.total = collectionResponse.data.total;
  collectionData.totalPages = collectionResponse.data.total_pages;
...
const research = () => {
  photoParams.query = queryString.value;
  collectionParams.query = queryString.value;
  userParams.query = queryString.value;
  search();
};
...
<template>
  <v-container class="photo-page">
    <v-toolbar color="primary">
      ...
      ></v-text-field>
      <v-spacer></v-spacer>
      <v-btn @click="research" color="">Go</v-btn>
    </v-toolbar>
    <v-row>
      <v-col cols="12" xl="10">
        <v-card class="mt-2">
